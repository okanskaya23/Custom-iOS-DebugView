...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // adding floating button to top level so that it can be seen from every screen
    ...
    @objc private func floatingButtonWasTapped(sender: UIButton) {
        window?.rootViewController?.present(LogsViewController(), animated: true)
